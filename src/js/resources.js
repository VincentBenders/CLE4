...
const Resources = {
    ...
    SanderHeadShot: new ImageSource('./images/time-out-sander.png'),
    VincentHeadShot: new ImageSource('./images/time-out-vincent.png'),
    MathijsHeadShot: new ImageSource('./images/time-out-mathijs.png'),
